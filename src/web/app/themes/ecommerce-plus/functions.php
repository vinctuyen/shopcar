...
if ( isset( $_GET['ecommerce_plus_notice_dismissed'] ) ){
          ...
          update_option('ecommerce_plus_help_notice', 'notice_nov24_dismissed');
}

$ecommerce_plus_help_notice = get_option('ecommerce_plus_help_notice', '');

if (($ecommerce_plus_help_notice != 'notice_nov24_dismissed' || $ecommerce_plus_help_notice === '') ){
